        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="page-title-normal checkout-title">
              <h2><span>管理收货地址</span></h2>
            </div>
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul>
                  <li v-for="item in limitAddressNum" :class="{'check':item.commonAddr===1}">
                    <dl>
...
// import {_getUserInfo} from '../api/address.js'
import $ from 'jquery'
  export default{
      data(){
          return{
      ...
      computed:{
        limitAddressNum:function(){
          console.log(this.addressData.slice(0, this.limitNum))
