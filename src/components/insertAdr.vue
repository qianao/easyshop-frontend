            ...
            <div class="md-content">
              <div class="confirm-tips">
                ...
                <div class="md-form-item">
                  ...
                  <div class="md-form-item__content" style="margin-left: 80px;">
                    <div  class="el-input">
                      <input type="text" autocomplete="off" class="md-input__inner" v-model="newProvince">
                    </div>
                  </div>
                </div>
                <div class="md-form-item">
                  ...
                  <div class="md-form-item__content" style="margin-left: 80px;">
                    <div  class="el-input">
                      <input type="text" autocomplete="off" class="md-input__inner" v-model="newCity">
                    </div>
                  </div>
                </div>
                <div class="md-form-item">
                  ...
                  <div class="md-form-item__content" style="margin-left: 80px;">
                    <div  class="el-input">
                      <input type="text" autocomplete="off" class="md-input__inner" v-model="newArea">
                    </div>
                  </div>
                </div>
                <div class="md-form-item">
...
import "../assets/css/modal.css"
    export default{
        ...
        methods:{
          ...
          saveVue() {
            var parametres = {'receiverName':this.newName,'address':this.newAddress,'tel':this.newTel,
              'postCode':this.newPostCode,'newCity':this.newCity,'newProvince':this.newProvince,
              'newArea' : this.newArea};
            var flag = this.checkForm(parametres);
            if (flag) {
              this.$emit("close")
              this.$emit("insertNewAdr",{'receiverName':this.newName,'address':this.newAddress,'tel':this.newTel,
                'postCode':this.newPostCode,'newCity':this.newCity,'newProvince':this.newProvince,
                'newArea' : this.newArea});
            }else {
              alert("请完整输入");
